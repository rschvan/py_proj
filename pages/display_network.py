...
# st.set_page_config(
#     page_title="Display Net",
#     page_icon="🌐")

pic = st.session_state.pic # alias for easy reference

# st.write(f"Layout  {st.session_state.layout}  ")
# st.pyplot(fig=pic.fig, width='content')
...
st.subheader(f"{pic.net.name}: {pic.net.nnodes} nodes and {pic.net.nlinks} links - {st.session_state.layout} layout")
