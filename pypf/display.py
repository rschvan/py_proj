...
if __name__ == "__main__":
    ...
    nodes_data = {
        ...
        "C": {"x": 100, "y": 150, "label": "Node C"},
        "D": {"x": 200, "y": 150, "label": "Node D"},
    }
    edges_data = [("A", "B"), ("B", "C"), ("C", "A"), ("B", "D")]

    root = tk.Tk()
    root.title("Basic Network Display")
    network_display = NetworkDisplay(root, nodes_data, edges_data, width=400, height=300)
