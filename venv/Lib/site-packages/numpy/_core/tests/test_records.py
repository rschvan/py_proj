...
class TestFromrecords:
    def test_fromrecords(self):
        ...
        assert_equal(r['savep'].dtype.kind, 'i')
        assert_equal(r['loadp'].dtype.kind, 'U')
        assert_equal(r['loadp'].dtype.itemsize, 12)
...
class TestRecord:
    ...
    def test_out_of_order_fields(self):
        ...
        x = self._create_data()[['savep', 'loadp']]
        assert_equal(x.dtype.names, ('savep', 'loadp'))
        assert_equal(x.dtype.descr,
                     [('savep', '<i4'), ('loadp', '<i4'), ('', '|V4')])

        # names change order to match indexing, as of 1.14 - descr can't
        # represent that
        y = self._create_data()[['loadp', 'savep']]
        assert_equal(y.dtype.names, ('loadp', 'savep'))
