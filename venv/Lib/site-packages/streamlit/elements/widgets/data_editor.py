    ...
    def data_editor(
        ...
        *,
        ...
        column_order : Iterable[str] or None
            ...
            For example, ``column_order=("loadp", "savep")`` will display
            ``"loadp"`` first, followed by ``"savep"``, and will hide all other
            non-index columns.
        ...
        disabled : bool or Iterable[str | int]
            ...
            - An Iterable of column names and/or positional indices: The
              ...
              ``disabled=["savep", "loadp"]`` will disable editing for the
              columns named "savep" and "loadp".
