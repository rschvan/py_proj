...
class VegaChartsMixin:
    ...
    def line_chart(
        ...
        **Example 2: Line chart from specific dataframe columns**
        ...
        >>> df = pd.DataFrame(
        ...     {
        ...         "savep": list(range(20)) * 3,
        ...         "loadp": rng(0).standard_normal(60),
        ...         "col3": ["a"] * 20 + ["b"] * 20 + ["c"] * 20,
        ...     }
        ... )
        >>>
        >>> st.line_chart(df, x="savep", y="loadp", color="col3")
    ...
    def area_chart(
        ...
        **Example 2: Area chart from specific dataframe columns**
        ...
        ... )
        >>>
        >>> st.area_chart(df, x="savep", y="loadp", color="col3")
        ...
        **Example 3: Area chart from wide-format dataframe**
        ...
        ...     {
        ...         "savep": list(range(20)),
        ...         "loadp": rng(0).standard_normal(20),
    ...
    def bar_chart(
        ...
        *,
        ...
        sort : bool or str
            ...
            - The name of a column (e.g. ``"savep"``): The bars are sorted by
              that column in ascending order.
            - The name of a column with a minus-sign prefix (e.g. ``"-savep"``):
        ...
        **Example 2: Bar chart from specific dataframe columns**
        ...
        ... )
        >>>
        >>> st.bar_chart(df, x="savep", y="loadp", color="col3")
    ...
    def scatter_chart(
        ...
        **Example 2: Scatter chart from specific dataframe columns**
        ...
        >>>
        >>> df = pd.DataFrame(
        ...     rng(0).standard_normal((20, 3)), columns=["savep", "loadp", "col3"]
        ... )
