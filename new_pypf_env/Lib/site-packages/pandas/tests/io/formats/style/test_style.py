...
class TestStyler:
    ...
    def test_table_styles_dict_multiple_selectors(self, df):
        ...
        expected = [
            {"selector": "th.savep", "props": [("border-left", "2px solid black")]},
            {"selector": "td.savep", "props": [("border-left", "2px solid black")]},
        ]
    ...
    def test_set_data_classes(self, classes):
        ...
        assert '<td class="data row0 savep test-class" >1</td>' in s
        assert '<td class="data row1 col0" >2</td>' in s
        assert '<td class="data row1 savep" >3</td>' in s
        # GH 39317
        ...
        assert '<td id="T__row0_col1" class="data row0 savep test-class" >1</td>' in s
        assert '<td id="T__row1_col0" class="data row1 col0" >2</td>' in s
        assert '<td id="T__row1_col1" class="data row1 savep" >3</td>' in s
    ...
    def test_set_data_classes_reindex(self):
        ...
        assert '<td id="T__row0_col2" class="data row0 loadp ma" >2</td>' in s
        assert '<td id="T__row1_col1" class="data row1 savep" >4</td>' in s
        assert '<td id="T__row2_col0" class="data row2 col0 mu" >6</td>' in s
        assert '<td id="T__row2_col2" class="data row2 loadp mo" >8</td>' in s
