...
class format_parser:
    ...
    names : str or list/tuple of str
        ...
        form ``'savep, loadp, col3'``, or as a list or tuple of strings in the
        form ``['savep', 'loadp', 'col3']``.
    ...
    --------
    >>> import numpy as np
    >>> np.rec.format_parser(['<f8', '<i4'], ['savep', 'loadp'],
    ...                      ['T1', 'T2']).dtype
    dtype([(('T1', 'savep'), '<f8'), (('T2', 'loadp'), '<i4')])

    `names` and/or `titles` can be empty lists. If `titles` is an empty list,
    titles will simply not appear. If `names` is empty, default field names
    will be used.

    >>> np.rec.format_parser(['f8', 'i4', 'a5'], ['savep', 'loadp', 'col3'],
    ...                      []).dtype
    dtype([('savep', '<f8'), ('loadp', '<i4'), ('col3', '<S5')])
...
def array(obj, dtype=None, shape=None, offset=0, strides=None, formats=None,
    ...
    >>> r = np.rec.array(['abc','def'], names=['savep','loadp'])
    >>> print(r.savep)
    abc
