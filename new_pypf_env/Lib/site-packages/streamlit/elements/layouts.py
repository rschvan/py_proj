...
class LayoutsMixin:
    ...
    def columns(
        ...
        **Example 2: Use commands as container methods**
        ...
        >>> import numpy as np
        >>>
        >>> savep, loadp = st.columns([3, 1])
        >>> data = np.random.randn(10, 1)
        >>>
        >>> savep.subheader("A wide column with a chart")
        >>> savep.line_chart(data)
        >>>
        >>> loadp.subheader("A narrow column with the data")
        >>> loadp.write(data)
