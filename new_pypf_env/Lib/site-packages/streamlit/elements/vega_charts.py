...
class VegaChartsMixin:
    ...
    def line_chart(
        ...
        *,
        ...
        ...     {
        ...         "savep": np.random.randn(20),
        ...         "loadp": np.random.randn(20),
        ...         "col3": np.random.choice(["A", "B", "C"], 20),
        ...     }
        ... )
        >>>
        >>> st.line_chart(chart_data, x="savep", y="loadp", color="col3")
        ...
        >>>
        >>> chart_data = pd.DataFrame(
        ...     np.random.randn(20, 3), columns=["savep", "loadp", "col3"]
        ... )
        >>>
        >>> st.line_chart(
        ...     chart_data,
    ...
    def area_chart(
        ...
        *,
        ...
        ... )
        >>>
        >>> st.area_chart(chart_data, x="savep", y="loadp", color="col3")
    ...
    def bar_chart(
        ...
        *,
        ...
        ...         "loadp": np.random.randn(60),
        ...         "col3": ["A"] * 20 + ["B"] * 20 + ["C"] * 20,
        ...     }
        ... )
        >>>
        >>> st.bar_chart(chart_data, x="savep", y="loadp", color="col3")
    ...
    def scatter_chart(
        ...
        *,
        ...
        >>>
        >>> chart_data = pd.DataFrame(
        ...     np.random.randn(20, 4), columns=["savep", "loadp", "col3", "col4"]
        ... )
        >>>
        >>> st.scatter_chart(
        ...     chart_data,
