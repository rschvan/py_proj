...
class FileUploaderMixin:
    ...
    def file_uploader(
        ...
        *,  # keyword-only arguments:
        ...
        >>>
        >>> ss_file = st.file_uploader("Choose a file")
        >>> if ss_file is not None:
        ...     # To read file as bytes:
        ...     bytes_data = ss_file.getvalue()
        ...     st.write(bytes_data)
        >>>
        ...     # To convert to a string based IO:
        ...     stringio = StringIO(ss_file.getvalue().decode("utf-8"))
        ...     st.write(stringio)
        >>>
        ...
        ... )
        >>> for ss_file in uploaded_files:
        ...     bytes_data = ss_file.read()
        ...     st.write("filename:", ss_file.name)
        ...     st.write(bytes_data)
