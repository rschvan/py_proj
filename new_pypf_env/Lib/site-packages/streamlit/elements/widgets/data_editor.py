    ...
    def data_editor(
        ...
        *,
        ...
        column_order : Iterable of str or None
            ...
            visible. For example, ``column_order=("loadp", "savep")`` will display 'loadp'
            first, followed by 'savep', and will hide all other non-index columns. If
        ...
        disabled : bool or Iterable of str
            ...
            If an Iterable of column names is provided (e.g., ``disabled=("savep", "loadp"))``,
